...
export const checkAuthenticated = () => async dispatch => {
    if (AsyncStorage.getItem('access')) {
        ...
        const body = JSON.stringify({ token: AsyncStorage.getItem('access') });
...
export const signup = (first_name, last_name, email,adress,phone, password, re_password) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
    ...
    const body = JSON.stringify({ first_name, last_name, email,adress,phone, password, re_password});
